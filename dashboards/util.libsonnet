...

{
  ...
  dashboardDescriptionLink: 'The dashboards were generated using [Django-mixin](https://github.com/adinhodovic/django-mixin). Open issues and create feature requests in the repository.',
